 ...
 * @Author: songhao
 * @Date: 2020/9/14
 * @Description: 阴历和阳历互相转换
 */
public class LaunarUtil {
     ...
     * @return
     */
    public static Date getSolarDate(Date date){
        ...
        lunar.lunarDay = calendar.get(Calendar.DATE);

        Solar solar = LunarToSolar(lunar);

        Calendar newcalendar = Calendar.getInstance();
        newcalendar.set(Calendar.YEAR,solar.solarYear);
        newcalendar.set(Calendar.MONTH,solar.solarMonth - 1);
        newcalendar.set(calendar.DATE,solar.solarDay);
    ...
    public static Date getLunarDate(Date date){
        ...
        Calendar newcalendar = Calendar.getInstance();
        newcalendar.set(Calendar.YEAR,lunar.lunarYear);
        newcalendar.set(Calendar.MONTH,lunar.lunarMonth - 1);
        newcalendar.set(calendar.DATE,lunar.lunarDay);
        return newcalendar.getTime();
    }
